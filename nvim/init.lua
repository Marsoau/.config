...
vim.keymap.set("n", "<leader><C-r>", "<cmd>LspRestart<CR>")
...

  {
    ...
    config = function()
      require("nightfall").setup({
        transparent = true, -- This is the key to transparency
      })
    end,
  },
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		opts = {
			...
			spec = {
				...
				{ "<leader>e", group = "Netrw [E]xplorer" },
				{ "<leader>E", group = "Nerd [E]xplorer" },
